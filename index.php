...
function enqueue_page_scripts() {
	global $post;
	if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'posta_web_1')) {
...
add_action('wp_enqueue_scripts', __NAMESPACE__ . '\enqueue_page_scripts');
...
function render_shortcode() {
	return '<div class="wrap" id="posta-web-1"></div>';
}

add_shortcode('posta_web_1', __NAMESPACE__ . '\render_shortcode');